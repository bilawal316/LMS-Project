...
const Tasks =({ updateState, showNotification }) => {
    ...
    const getInsProjects = async (userId) => {
 ...
 useEffect(() => {
  ...
  return (
    <>
      <div className="w-full h-full  pt-12 bg-opacity-50 bg-indigo-200 text-purple-700">
      <div className="app">
            {loading ? <div className="flex ps-48 items-center justify-center h-screen">
                ...
                : (<div className="data-container">
                    <div className={`className="h-screen  fade-in w-screen flex  justify-end ${showNotification ? 'blurr -z-50' : ''}`}>
                                ...
                                <div className="flex flex-col w-form gap-2 p-6 rounded-md shadow-md bg-white opacity-100 text-black">
                                    ...
                                    <div className="mt-4">
                                        ...
                                        <input
                                            ...
                                            placeholder="Title"
                                            className="border w-full p-2 mb-2 bg-white"
                        ...
                        {isAddModalOpen && (
                            <div className="modal-container  flex items-center justify-center z-100">
                                <div className="absolute  bg-white opacity-50" onClick={() => setAddModalOpen(false)}></div>
                                <div className="flex flex-col w-form gap-2 p-6 rounded-md shadow-md bg-white opacity-100 text-black">
                                    <h2 className="text-xl font-semibold text-center leading tracking">
                                        Add Task
                                    </h2>
                        ...
                        <div className={`h-full w-full flex ${contentClassName}`}>
                            <div className=" w-full">
                                <nav aria-label="breadcrumb" className="text-black p-4 dark:text-gray-100">
                                    <ol className="text-black mt-6 flex h-8 space-x-2 dark:text-gray-100">
                                        <li className="text-black flex items-center">
                                            <a rel="noopener noreferrer" href="#" title="Back to homepage" className="text-purple-700 text-sm hover:text-purple-900 flex items-center hover:underline">Instructor</a>
                                        </li>
                                        <li className="flex items-center space-x-1">
                                            <span className="dark:text-gray-400">/</span>
                                            <a rel="noopener noreferrer" href="#" className="text-purple-700 text-sm hover:text-purple-900 flex items-center px-1 capitalize hover:underline">Tasks</a>
                                        </li>

                                    </ol>
                                    <h3 className="font-bold text-2xl text-purple-700">Tasks</h3>

                                </nav>
                                <div className="container p-2 sm:p-4 text-black">
                                    <h4 className="font-semibold text-md mb-2  ">Select Project</h4>

                                    <div className="flex">
                                        {insProjects.length != 0 && (
